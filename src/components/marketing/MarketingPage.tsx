        ...
        >
          ...
          <div className="flex items-center gap-3">
            <button
              ...
              className="text-sm font-semibold text-[#57534E] hover:text-[#1A1715] px-4 py-2 rounded-xl transition-colors focus:outline-none focus:ring-2 focus:ring-amber-500"
            >
              Sign In
            </button>
            <button
