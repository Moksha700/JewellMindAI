...
import { KNOWLEDGE_BASE_DATA, KBCategory } from '../data/knowledgeBaseData';

/**
 * Generates a publication-grade, multi-page PDF document of the JewelMind AI Knowledge Base.
 */
export function generateKnowledgeBasePDF(): void {
  const doc = new jsPDF({
  ...
  doc.setFont('helvetica', 'normal');
  doc.setFontSize(13);
  doc.setTextColor(245, 215, 130); // Soft gold
  ...
  // Render Each Category and Article
  ...
  // Trigger download
  doc.save('JewelMind_AI_Knowledge_Base.pdf');
}
